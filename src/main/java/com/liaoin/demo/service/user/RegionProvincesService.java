...
public interface RegionProvincesService {
	 ...
	 * @return 前端返回格式
	 */
    Result insert(String token, RegionProvinces regionProvinces);
    /**
	 * 修改
	 *
	 * @param token token
	 ...
	 * @return 前端返回格式
	 */
    Result update(String token, RegionProvinces regionProvinces);
    /**
	 * 根据主键删除
	 *
	 * @param token token
	 ...
	 * @return 前端返回格式
	 */
    Result pageQuery(String token, Integer page, Integer size, String sort, RegionProvinces regionProvinces);
}
