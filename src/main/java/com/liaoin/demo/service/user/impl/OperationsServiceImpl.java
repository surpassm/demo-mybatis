...
public class OperationsServiceImpl implements OperationsService {
    ...
    @Override
    public Result insert(String token,Operations operations) {
        if (operations == null){
    ...
    @Override
    public Result update(String token,Operations operations) {
        if (operations == null){
            return fail(ResultCode.PARAM_IS_BLANK.getMsg());
        }
        UserInfo loginUser = beanConfig.getAccessToken(token);
    ...
    @Override
    public Result pageQuery(String token,Integer page, Integer size, String sort, Operations operations) {
